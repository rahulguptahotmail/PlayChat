...
const Profile = () => {
  ...
  return (
    <div className=" ms-md-4 ps-md-5">
      {edit ? (
        <div className=" position-absolute bg-body-tertiary rounded shadow ms-5 p-5  z-3" style={{ top:"8.3vh"}}>
         <EditProfile/>
        </div>
      ) : (
        ""
      ...
      />
      <div className=" position-relative">
        <i className="fa-solid fa-pen-to-square position-absolute bottom-50 end-0 pb-3 pe-3 fs-4 pointer " onClick={()=>setEdit(!edit)}></i>
      </div>
